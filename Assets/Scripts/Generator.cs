...
#region Perform Marching Cubes
    ...
    /// <summary>
    /// Merges nearby vertices, similarly to "remove doubles" in Blender.
    /// Pulled from:
    /// https://answers.unity.com/questions/228841/dynamically-combine-verticies-that-share-the-same.html
    /// 
    /// The goal of this method is to hopefully remove some of the thin triangles 
    /// generated by both MC and DMC. However, it breaks normal and UV computation
    /// code (and runs out of memory).
    /// 
    /// </summary>
    /// <param name="mesh">Mesh.</param>
    /// <param name="threshold">Threshold.</param>
    /// <param name="bucketStep">Bucket step.</param>
    public static void AutoWeld(Mesh mesh, float threshold, float bucketStep)
    {
        ...
        Debug.Log($"Cleaned up {mesh.vertices.Length} vertices into {finalVertices.Length} final vertices.");
