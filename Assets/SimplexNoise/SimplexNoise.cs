...
public class SimplexNoiseGenerator {
	...
	public float GetValue(float x, float y, float z, int octaves=4, int multiplier = 1, float amplitude = 0.5f, float lacunarity = 2, float persistence = 0.5f) {
	...
	public int getDensity(Vector3 loc) {
		float val = GetValue(loc.x, loc.y, loc.z);
